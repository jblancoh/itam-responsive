...
$sentwt = $_GET['sentwt'];
$urlajx = "/itam2/postt/twitteroauth/index.php";
...
POV;
  ...
  <style>
    ...
    .bt
    {
      background: white url('pics/enviar.jpg') no-repeat top;
      width: 69px;
      height: 24px;
      color:white;
      border: 0px;
...
.ownerlink {color: #000; font-weight: bold;
   ...
   .timage {height: 48px; margin-left: 10px; margin-top: 5px; margin-bottom: 5px;margin-right:10px;}
   .tdate {color: #8b8b8b;}
